...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		path.set ("assets/images/btn1-1.png", "assets/images/btn1-1.png");
		type.set ("assets/images/btn1-1.png", AssetType.IMAGE);
		path.set ("assets/images/btn1.png", "assets/images/btn1.png");
		type.set ("assets/images/btn1.png", AssetType.IMAGE);
		path.set ("assets/images/hud_bottom.png", "assets/images/hud_bottom.png");
		type.set ("assets/images/hud_bottom.png", AssetType.IMAGE);
		path.set ("assets/images/hud_top.png", "assets/images/hud_top.png");
		type.set ("assets/images/hud_top.png", AssetType.IMAGE);
		...
		path.set ("assets/images/mapbtn.png", "assets/images/mapbtn.png");
		type.set ("assets/images/mapbtn.png", AssetType.IMAGE);
		path.set ("assets/images/plnt1.png", "assets/images/plnt1.png");
		type.set ("assets/images/plnt1.png", AssetType.IMAGE);
		...
		id = "assets/images/btn1-1.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/btn1.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/hud_bottom.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/hud_top.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		...
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/mapbtn.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/plnt1.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
